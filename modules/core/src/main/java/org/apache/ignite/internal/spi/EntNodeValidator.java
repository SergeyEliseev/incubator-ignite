...
package org.apache.ignite.internal.spi;
...
/**
 * Validate node's versions.
 */
public class EntNodeValidator extends NodeValidator {

    /** {@inheritDoc} */
    @Override public IgniteSpiNodeValidationResult validateNode(ClusterNode locNode, ClusterNode node) {
        // Check version.
